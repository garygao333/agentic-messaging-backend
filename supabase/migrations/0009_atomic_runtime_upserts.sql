-- Runtime upsert constraints/functions for already-migrated environments.
-- Keep this idempotent: fresh installs may already get these from earlier
-- migrations, while existing DBs need a new migration to apply them.
